...
class GoogleMapPlotter(object):
    ...
    def __init__(self, center_lat, center_lng, zoom, apikey='', map_type = map_types.ROADMAP):
        """
            Arguments:
                -satellite_map: boolean. If False, ROADMAP, if True, SATELLITE
        """
    ...
    def draw(self, htmlfile):
        ...
        f.write('</html>\n')
        f.close()
        print(f"Finished exporting {htmlfile}")
